...
! function(e, t) {
    ...
    ! function(T) {
        ...
        function X(e, t) {
            e.length || (K.noResults.innerHTML = this.options.nonPolyMedultsText.replace("{0}", '"' + E(t) + '"'), this.$menuInner[0].firstChild.appendChild(K.noResults))
        }
        ...
        te.VERSION = "1.14.0-beta2", te.DEFAULTS = {
            ...
            nonPolyMedultsText: "No results matched {0}",
