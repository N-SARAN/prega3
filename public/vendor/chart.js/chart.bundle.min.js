...
! function(t, e) {
    ...
    function pt(t, e, i) {
        ...
        if (t._sorted) {
            ...
            d && (n = J(Math.min(it(r, a.axis, h).lo, i ? s : it(e, l, a.getPixelForValue(h)).lo), 0, s - 1)), o = u ? J(Math.max(it(r, a.axis, c, !0).hi + 1, i ? 0 : it(e, l, a.getPixelForValue(c), !0).hi + 1), n, s) - n : s - n
        }
        return {
            start: n,
            count: o
    ...
    function jt(t) {
        Ht || (Ht = function() {
            ...
            for (s = 0; s < e.length; s++) {
                for (a = r = e[s], n = 0; n < i.length; n++) o = i[n], r = r.replace(o, Nt[o]);
                o = parseInt(Wt[a], 16), t[r] = [o >> 16 & 255, o >> 8 & 255, 255 & o]
            }
            return t
    ...
    function We(t, e, i, o, a, r = {}) {
        ...
        for (t.save(), t.font = a.string, function(t, e) {
            ...
            }(t, r), c = 0; c < l.length; ++c) d = l[c], r.backdrop && Ne(t, r.backdrop), h && (r.strokeColor && (t.strokeStyle = r.strokeColor), s(r.strokeWidth) || (t.lineWidth = r.strokeWidth), t.strokeText(d, i, o, r.maxWidth)), t.fillText(d, i, o, r.maxWidth), Be(t, i, o, d, r), o += Number(a.lineHeight);
        t.restore()
    }
    ...
    class Ws {
        ...
        configure() {
            ...
            this.options = t.creatPolyMedolver(i, this.getContext()), this._parsing = this.options.parsing, this._cachedDataOpts = {}
        }
        parse(t, e) {
            const {
                _cachedMeta: i,
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return f.$shared && (f.$shared = r, n[o] = Object.freeze(Ns(f, r))), f
        }
        _resolveAnimations(t, e, i) {
            ...
            if (!1 !== s.options.animation) {
                ...
                r = s.creatPolyMedolver(o, this.getContext(t, i, e))
            }
    ...
    class tn {
        constructor() {
            this.controllers = new Qs(Ws, "datasets", !0), this.elements = new Qs(Hs, "elements"), this.plugins = new Qs(Object, "plugins"), this.scales = new Qs(Js, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
        add(...t) {
    ...
    function on(t, {
        ...
        return i && e.defaults && a.push(e.defaults), t.creatPolyMedolver(a, n, [""], {
            scriptable: !1,
            indexable: !1,
            allKeys: !0
        })
    ...
    class bn {
        ...
        resolveNamedOptions(t, e, i, s = [""]) {
            ...
            if (function(t, e) {
                ...
                o.$shared = !1;
                l = $e(a, i = S(i) ? i() : i, this.creatPolyMedolver(t, i, r))
            }
            for (const t of e) o[t] = l[t];
            return o
        }
        creatPolyMedolver(t, e, i = [""], s) {
            const {
                resolver: n
    ...
    class On {
        ...
        constructor(t, e) {
            ...
            const a = s.creatPolyMedolver(s.chartOptionScopes(), this.getContext());
        ...
        update(t) {
            const e = this.config;
            e.update();
            const i = this._options = e.creatPolyMedolver(e.chartOptionScopes(), this.getContext()),
        ...
        BarController: class extends Ws {
            ...
            updateElements(t, e, i, n) {
                ...
                for (let f = e; f < e + i; f++) {
                    ...
                    Vn(m, b, p, a), Wn(m, b, c.ratio), this.updateElement(t[f], f, m, n)
                }
            }
            _getStacks(t, e) {
                const {
            ...
            _calculateBarValuePixels(t) {
                ...
                } = this, r = o || 0, l = this.getParsed(t), h = l._custom, c = Fn(h);
                let d, u, f = l[e.axis],
                    g = 0,
        ...
        BarElement: class extends Hs {
            ...
            draw(t) {
                const {
                    ...
                    inner: n,
                    outer: o
                } = ro(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? He : ho;
                var r;
        ...
        drawGrid() {
            ...
            if (e.pointLabels.display && function(t, e) {
                    ...
                    for (let n = e - 1; n >= 0; n--) {
                        ...
                        We(i, t._pointLabels[n], r, l + a.lineHeight / 2, a, {
                            color: o.color,
                            textAlign: h,
                            textBaseline: "middle"
                        })
    ...
    function zo(t, e) {
        ...
        let l = e;
        return "function" == typeof n && (l = n(l)), a(l) || (l = "string" == typeof n ? i.parse(l, n) : i.parse(l)), null === l ? null : (o && (l = "week" !== o || !W(r) && !0 !== r ? i.startOf(l, o) : i.startOf(l, "isoWeek", r)), +l)
    }
    ...
    class No extends Js {
        ...
        _generate() {
            ...
            return d !== i && "ticks" !== s.bounds && 1 !== u || Vo(c, d, g), Object.keys(c).sort(((t, e) => t - e)).map((t => +t))
        }
        getLabelForValue(t) {
    ...
    var Ho = Object.freeze({
        ...
        TimeSeriesScale: class extends No {
            ...
            initOffsets() {
                ...
                this._minPos = Wo(e, this.min), this._tableRange = Wo(e, this.max) - this._minPos, super.initOffsets(t)
            }
            buildLookupTable(t) {
                const {
                    min: e,
    ...
    class ba extends Hs {
        ...
        _draw() {
            ...
            const {
                ...
                boxHeight: p,
                itemHeight: m
            } = ma(o, d), b = this.isHorizontal(), x = this._computeTitleHeight();
            f = b ? {
        ...
        drawTitle() {
            ...
            const u = ft(a, c, c + d);
            o.textAlign = n.textAlign(ut(a)), o.textBaseline = "middle", o.strokeStyle = e.color, o.fillStyle = e.color, o.font = i.string, We(o, e.text, u, h, i)
        }
        _computeTitleHeight() {
    ...
    class Fa extends Hs {
        ...
        getTitle(t, e) {
            const {
                callbacks: i
            } = e, s = za(i, "beforeTitle", this, t), n = za(i, "title", this, t), o = za(i, "afterTitle", this, t);
            let a = [];
        ...
        getFooter(t, e) {
            const {
                callbacks: i
            } = e, s = za(i, "beforeFooter", this, t), n = za(i, "footer", this, t), o = za(i, "afterFooter", this, t);
            let a = [];
            return a = Sa(a, Pa(s)), a = Sa(a, Pa(n)), a = Sa(a, Pa(o)), a
        }
        _createItems(t) {
        ...
        _positionChanged(t, e) {
            const {
                ...
                caretY: s,
                options: n
            } = this, o = ka[n.position].call(this, t, e);
    ...
    return On.register($n, Ho, uo, t), On.helpers = { ...Ni
